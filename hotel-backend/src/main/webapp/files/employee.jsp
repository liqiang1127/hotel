...
<body class="ContentBody">
	<form action="${pageContext.request.contextPath}/employee!editEmployee.action" method="post" enctype="multipart/form-data" name="fom"
										...
										<table border="0" cellpadding="2" cellspacing="1"
											style="width: 100%">
												...
												<td width="41%"><input name="name" class="text"
													style="width: 250px" type="text" size="40"  value="${user.name }"/> <span
													class="red"> *</span></td>
													<td nowrap align="right" width="13%">工号:</td>
												<td width="41%"><input name="staffId" class="text"
													style="width: 250px" type="text" size="40"  value="${user.staffId }" readonly="readonly"/> <span
													class="red"> *</span></td>
											</tr>
											<tr>
												<td nowrap align="right" width="13%">手机号码:</td>
												<td width="41%"><input name="mobile" class="text"
													style="width: 250px" type="text" size="40"  value="${user.mobile }"/> <span
													class="red"> *</span></td>
											</tr>
										</table>
										<br />
