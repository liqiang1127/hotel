...
public class RoomBean implements Serializable{
	...
	private String area; // 朝向朝南朝北 0 南 1 北
	...
	public String getRoomKindStr() {
		return roomKindStr;
	}
	public void setRoomKindStr(String roomKindStr) {
		this.roomKindStr = roomKindStr;
	}
