...
<body class="ContentBody">
	<form action="${pageContext.request.contextPath}/department!editDepartment.action" method="post" enctype="multipart/form-data" name="fom"
		id="fom" target="mainFrame">
		<div class="MainDiv">
			<table width="99%" border="0" cellpadding="0" cellspacing="0"
				class="CContent">	
				<tr>
					<th class="tablestyle_title">部门修改页面</th>
				</tr>
				<tr>
					<td class="CPanel">
