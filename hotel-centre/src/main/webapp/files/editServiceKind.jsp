...
<body class="ContentBody">
	<form action="${pageContext.request.contextPath}/serviceKind!editServiceKind.action" method="post" enctype="multipart/form-data" name="fom"
		id="fom" target="mainFrame">
		<div class="MainDiv">
			<table width="99%" border="0" cellpadding="0" cellspacing="0"
				class="CContent">	
				<tr>
					<th class="tablestyle_title">服务种类新增页面</th>
				</tr>
				<tr>
					<td class="CPanel">
							...
							<TR>
								...
								<h1 style="color: red ;text-align:center" >${errorInfo }</h1>
									<fieldset style="height: 100%;">
										<legend>服务种类信息修改</legend>
										<table border="0" cellpadding="2" cellspacing="1"
											style="width: 100%">
											<tr><input type="hidden" name="id" value="${serviceKind.id }"/></tr>
											<tr>
