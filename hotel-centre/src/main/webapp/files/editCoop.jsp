...
<body class="ContentBody">
	<form action="${pageContext.request.contextPath}/coop!editCoop.action" method="post" enctype="multipart/form-data" name="fom"
										...
										<table border="0" cellpadding="2" cellspacing="1"
											...
											<tr>
												...
												<td><select name="state">
														<option value="0" ${cooperation.state == '1'?'selected':''}>正常</option>
														<option value="1" ${cooperation.state == '1'?'selected':''}>挂起</option>
												</select></td>
											</tr>
											<tr>
