...
<%-- 	<form action="${pageContext.request.contextPath}/room!addRoom.action" method="post" enctype="multipart/form-data" name="fom"
		...
		<div class="MainDiv">
			<table width="99%" border="0" cellpadding="0" cellspacing="0"
				class="CContent">	
				<tr>
					<th class="tablestyle_title">到店入住页面</th>
				</tr>
				<tr>
					<td class="CPanel">
						...
						<table border="0" cellpadding="0" cellspacing="0"
							...
							<form name="fom" id="fom" method="post" action="${pageContext.request.contextPath}/room!queryRoom.action">
									<tr>
										...
										<td width="538">查看内容：房间号： <input name="no"
											type="text" size="20"  value="${no}"/> &nbsp; &nbsp;&nbsp;
																						<input type="hidden" value="addCheckin" name="fromPage"/>
											楼层： <input name="floor"
								...
								<table width="100%" border="0" cellpadding="4"
												...
												<tr bgcolor="#FFFFFF">
													...
													<td>
														<button onclick="checkin(${room.id })">入住</button>
													</td>
												</tr>
												</c:forEach>
											</table>
							...
							<TR>
								<TD width="100%">
									<fieldset style="height: 100%;display: none;" id="checkinOrder">
										<legend>客房入住登记</legend>
										<form method="post" action="${pageContext.request.contextPath}/service!checkIn.action">
										<table border="0" cellpadding="2" cellspacing="1"
											style="width: 100%" id="guestTable" >
											<TR>
											...
											<tr>
													<td nowrap align="right" width="13%">客房编号:</td>
												<td><input type="text" name="room_id" id="room_id" value="" readonly="readonly" width="100px"/>
											...
											<tr style="display:none;" class="payNoRow">
												...
												<td><input name="outTradeNo" 
													...
													class="red"> *</span></td>
												<td align="center" rowspan="3"  colspan="2"><img src="" id="cede"  ></td>
											</tr>
...
<script type="text/javascript">
	function checkin(id){
		checkinOrder.style.display="block";
		room_id.value=id;
	}
